...
app.config.globalProperties.$d = {
  ...
  dicts: [
    ...
    [170, '30%', '10%', '10%', 100, '单体', '普通', '无'],
    [-100, '+15%', '-5%', null, -50, null, null, null],
    ['攻击', '耐久', '命中', '会心', '载重', '范围', '属性', '弹仓', '重量'],
    [2000, 135, '30%', '30%', '112.00t', '单体', '普通', '48/62', '15.00t'],
    [-1000, -100, null, null, '+100.00t', null, null, null, '-10.00t'],
    ['战斗等级', '驾驶等级', '命中', '闪避', '腕力', '体力', '速度'],
    ['底盘特性', '底盘抗性', '备用弹仓', '货架容量', null, '最大载重', '装甲重量', '装备重量'],
    ['会心一击', '火焰', '10/128', '4/20', null, '115.36t', '32.00t', '83.36t']
  ]
};
